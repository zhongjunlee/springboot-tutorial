 ...
 */
@Configuration
@MapperScan(basePackages = "com.johnny.dynamicdatasource.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
...
![image-20190905164824155](http://static.johnny.com/spring-boot-demo/dynamic-datasource/062351.png)

通过 PostMan 等工具测试

- 默认数据源查询

![image-20190905165240373](http://static.johnny.com/spring-boot-demo/dynamic-datasource/062353.png)

- 根据数据源id为1的数据源查询

![image-20190905165323097](http://static.johnny.com/spring-boot-demo/dynamic-datasource/062354.png)

- 根据数据源id为2的数据源查询

![image-20190905165350355](http://static.johnny.com/spring-boot-demo/dynamic-datasource/062355.png)
...
public class DatasourceSelectorAspect {
    @Pointcut("execution(public * com.johnny.dynamic.datasource.controller.*.*(..))")
