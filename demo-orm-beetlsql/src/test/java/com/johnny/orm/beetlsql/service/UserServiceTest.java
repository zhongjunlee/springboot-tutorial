package com.johnny.orm.beetlsql.service;
...
import com.johnny.orm.beetlsql.SpringBootDemoOrmBeetlsqlApplicationTests;
...
public class UserServiceTest extends SpringBootDemoOrmBeetlsqlApplicationTests {
    ...
    public void saveUser() {
        ...
        User user = User.builder().name("testSave3").password(SecureUtil.md5("123456" + salt)).salt(salt).email("testSave3@johnny.com").phoneNumber("17300000003").status(1).lastLoginTime(new DateTime()).createTime(new DateTime()).lastUpdateTime(new DateTime()).build();
