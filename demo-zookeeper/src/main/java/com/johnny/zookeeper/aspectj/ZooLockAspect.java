package com.johnny.zookeeper.aspectj;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.johnny.zookeeper.annotation.LockKeyParam;
import com.johnny.zookeeper.annotation.ZooLock;
...
public class ZooLockAspect {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.johnny.zookeeper.annotation.ZooLock)")
    public void doLock() {
