...
logging:
  level:
    com.johnny.multi.datasource.mybatis: debug
```
...
![image-20190121153211509](http://static.johnny.com/spring-boot-demo/multi-datasource/mybatis/063506.jpg)

**从**库 **建议** 只执行 **SELECT** 操作

![image-20190121152825859](http://static.johnny.com/spring-boot-demo/multi-datasource/mybatis/063505.jpg)
