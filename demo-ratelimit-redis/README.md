...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.johnny.ratelimit.redis.annotation.RateLimiter)")
...
![image-20190930155856711](http://static.johnny.com/spring-boot-demo/ratelimit/redis/063812.jpg)

- 触发限流的时候 Redis 的数据

![image-20190930155735300](http://static.johnny.com/spring-boot-demo/ratelimit/redis/063813.jpg)
