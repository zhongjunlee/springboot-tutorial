 ...
 * {@link com.johnny.oauth.config.Oauth2AuthorizationServerConfig}
 * 授权服务器相关的配置，主要设置授权服务器如何读取客户端、用户信息和一些端点配置
 * 可以在这里配置更多的东西，例如端点映射，token 增强等
 * <p>
 * {@link com.johnny.oauth.config.Oauth2AuthorizationTokenConfig}
 * 授权服务器 token 相关的配置，主要设置 jwt、加密方式等信息
 * <p>
 * {@link com.johnny.oauth.config.ClientLogoutSuccessHandler}
 ...
 */
package com.johnny.oauth.config;
