...
spring:
  mail:
    ...
    port: 465
    username: spring-boot-demo@johnny.com
    # 使用 jasypt 加密密码，使用com.johnny.email.PasswordTest.testGeneratePassword 生成加密密码，替换 ENC(加密密码)
...
public class MailServiceTest extends SpringBootDemoEmailApplicationTests {
    ...
    public void sendHtmlMail() throws MessagingException {
        ...
        context.setVariable("url", "https://github.com/johnny/spring-boot-demo");
    ...
    public void sendAttachmentsMail() throws MessagingException {
        URL resource = ResourceUtil.getResource("static/johnny.png");
    ...
    <div style="width: 100%;height: 100%;text-align: center;display: flex">
        ...
        <div style="display: flex;width: 400px;">
            <div style="flex: 1;text-align: center;">
                <div>
                    <img width="180px" height="180px" src="http://johnny.com/resources/wechat-reward-image.png">
                </div>
                <div>微信打赏</div>
            </div>
            <div style="flex: 1;text-align: center;">
                <div><img width="180px" height="180px" src="http://johnny.com/resources/alipay-reward-image.png">
                </div>
                <div>支付宝打赏</div>
            </div>
        </div>
